-- Script final sécurisé pour créer les tables presences
-- Presence CCRB - Création sécurisée et robuste
...
-- 5. Vérifier et ajouter les contraintes de clés étrangères de manière ultra-sécurisée
-- Contrainte presences -> users
DO $$
BEGIN
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'users') 
       AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'presences' AND column_name = 'user_id') THEN
        BEGIN
...
BEGIN
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'users') 
       AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'missions' AND column_name = 'user_id') THEN
        BEGIN
...
BEGIN
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'users') 
       AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'checkins' AND column_name = 'user_id') THEN
        BEGIN
...
BEGIN
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'missions') 
       AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'checkins' AND column_name = 'mission_id') THEN
        BEGIN
            ALTER TABLE checkins 
...
DO $$
BEGIN
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'communes') 
       AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'villages' AND column_name = 'commune_id') THEN
        BEGIN
...
-- 6. Créer les index de manière ultra-sécurisée
...
BEGIN
    ...
    -- Index location
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'presences' AND column_name = 'location_lat') 
       AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'presences' AND column_name = 'location_lng') THEN
...
BEGIN
    ...
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'checkins' AND column_name = 'lat') 
       AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'checkins' AND column_name = 'lon') THEN
