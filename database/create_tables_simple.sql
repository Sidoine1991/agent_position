-- =====================================================
-- Script simplifié de création des tables CCRB
...
-- =====================================================
-- 6. SYSTÈME D'ANALYTICS ET INSIGHTS
-- =====================================================
...
-- =====================================================
-- 7. SYSTÈME DE GÉOLOCALISATION AVANCÉE
-- =====================================================
...
('Premiers pas avec l''application', 'Apprenez les bases de l''application CCRB', 5, 'beginner', 'general', 
 '[{"title": "Connexion", "content": "Connectez-vous avec vos identifiants fournis par votre superviseur", "image": "/help/images/login.png"}, {"title": "Marquer sa présence", "content": "Cliquez sur le bouton \"Marquer ma présence\" et confirmez votre localisation", "image": "/help/images/presence.png"}]'::jsonb),
('Utilisation du GPS et géolocalisation', 'Maîtrisez les fonctionnalités de géolocalisation', 8, 'intermediate', 'presence',
 '[{"title": "Activer le GPS", "content": "Autorisez l''accès à votre localisation dans les paramètres du navigateur", "image": "/help/images/gps-activation.png"}, {"title": "Vérifier la précision", "content": "Assurez-vous que votre position est précise avant de marquer votre présence", "image": "/help/images/gps-accuracy.png"}]'::jsonb),
('Création de rapports enrichis', 'Créez des rapports détaillés avec photos et audio', 12, 'advanced', 'reports',
 '[{"title": "Accéder aux rapports enrichis", "content": "Naviguez vers la page \"Rapports Enrichis\" depuis le menu principal", "image": "/help/images/enriched-reports.png"}, {"title": "Capturer des photos", "content": "Utilisez le bouton \"Photo\" pour prendre des photos de vos activités", "image": "/help/images/photo-capture.png"}]'::jsonb)
ON CONFLICT DO NOTHING;
