...
const DISCOVERED_TABLES = [
  ...
  'communes', 'arrondissements', 'villages', 'verification_codes',
  'notifications', 'reports', 'report_presence_view', 'departements',
  'presences', 'absences', 'custom_reports', 'activity_logs', 'app_settings'
];
...
Tables sauvegardées: ${successCount}/${DISCOVERED_TABLES.length}
...
Tables incluses dans cette sauvegarde:
