// Système de nettoyage des ressources
    (function () {
      'use strict';
      ...
      const cleanupRegistry = {
        ...
        addEventListener(element, event, handler, options) {
          if (!this.eventListeners.has(element)) {
            ...
            // Ajouter un gestionnaire pour nettoyer lors de la suppression de l'élément
        ...
        // Envelopper fetch pour annuler les requêtes en cours
        wrapFetch() {
          ...
          window.fetch = (resource, init = {}) => {
            ...
            // Supprimer la référence une fois la requête terminée
  ...
  <script>
     ...
     */
    function applyDashboardFilter(options = {}) {
      try {
