    ...
    try {
      ...
      try {
        const missionData = {
          ...
          // Même logique qu'en ligne: stocker les noms tels que vus par l'agent
          departement: getGeoValue('departement') || null,
          commune: getGeoValue('commune') || null,
          arrondissement: getGeoValue('arrondissement') || null,
          village: getGeoValue('village') || null,
